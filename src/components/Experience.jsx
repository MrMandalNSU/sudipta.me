...
const Experience = ({ id }) => {
  const experiences = [
    ...
    },
    {
      ...
      achievements: [
        "Built and maintained SportsFixtures.net from scratch using Node.js, Strapi v5, PostgreSQL, Neon DB, Redis, and Cloudinary; deployed and managed production infrastructure on Railway with centralized logging, monitoring, and environment management.",
        "Designed and optimized 20+ relational database models and advanced multi-model filtering/query systems, improving large-scale data retrieval performance by 40%.",
        "Implemented secure authentication and authorization features including SMTP OTP verification, Google OAuth, and Facebook OAuth, improving login reliability and reducing authentication friction.",
        "Integrated complete SportsDB v1/v2 APIs and multiple third-party News APIs; developed automated cron job schedulers and background workers that reduced API synchronization downtime by 70%.",
        "Built real-time live sports score functionality using WebSocket connections and optimized backend performance with Redis and Node cache strategies, reducing redundant API/database load by 50%.",
        "Leveraged AI-assisted context engineering and agentic workflow automation to accelerate development workflows and improve engineering productivity by 50%.",
      ],
      technologies: [
        "Node.js",
        "Strapi v5",
