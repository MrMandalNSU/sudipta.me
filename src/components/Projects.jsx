...
const Projects = ({ id }) => {
  const projects = [
    ...
    },
    {
      ...
      tryAssistant: true,
      achievements: [
        "Built the full AskSudipta chat system directly inside this portfolio, including the React and Material UI floating assistant plus a TypeScript and Express RAG backend; users can click the Try Assistant button to open the chat window and test it live.",
    ...
    },
    {
      ...
      achievements: [
        "Engineered an automated Node.js and Express backend system to scrape daily End-of-Day (EOD) SME market statistics and transactions from the Dhaka Stock Exchange (DSE). Designed a high-reliability HTML table parsing pipeline that robustly handles raw layout text to extract daily stock records, public board metrics, and block trades.",
