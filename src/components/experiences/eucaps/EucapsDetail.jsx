...
const EucapsDetail = () => {
  ...
  const [activeSystemNode, setActiveSystemNode] = useState("auth");
  const [activeTable, setActiveTable] = useState("S&P Financials");
  const [activeWorkflow, setActiveWorkflow] = useState("sp_pipeline");

  /* ── SEO Meta updates ── */
  useEffect(() => {
    // 1. Update Document Title
    document.title = "Eucaps - Software Engineer Financial Integrations & AI Systems | Sudipta Mandal";
