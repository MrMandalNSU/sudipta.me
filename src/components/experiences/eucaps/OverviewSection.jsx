        ...
        <Grid size={{ xs: 12, md: 8 }}>
          <GlassCard sx={{ p: 3.5, height: "100%", display: "flex", flexDirection: "column" }}>
            ...
            <Typography variant="body1" sx={{ mb: 2.5, lineHeight: 1.8, color: "text.primary" }}>
              At <strong>Eucaps AB</strong>, Sudipta Mandal served as Software Engineer I → II, driving product features from development to scaling.
              He orchestrated the ingestion pipelines for institutional financial metrics, developed third-party developer APIs, and automated compliance verification loops.
            </Typography>
            <Typography variant="body2" color="text.secondary" sx={{ mb: 0, lineHeight: 1.7 }}>
              Through gradual growth and deep product ownership, Sudipta integrated services from S&P Capital IQ, Pinpoint, and Inderes.
              He fortified client authorization using dual Swedish BankID and OTP solutions, while streamlining profile creation through scheduled batch AI operations.
            </Typography>
          </GlassCard>
        </Grid>
        ...
        <Grid size={{ xs: 12, md: 4 }}>
          <GlassCard sx={{ p: 3.5, height: "100%", display: "flex", flexDirection: "column", justifyContent: "center" }}>
            ...
            <Box sx={{ display: "flex", flexWrap: "wrap", gap: 1, mb: 3.5 }}>
              ...
              <Chip label="Stockholm, Sweden" size="small" sx={{ fontWeight: 700, backgroundColor: "rgba(245, 158, 11, 0.1)", color: "#f59e0b", borderRadius: 1.5, border: "none" }} />
            </Box>
