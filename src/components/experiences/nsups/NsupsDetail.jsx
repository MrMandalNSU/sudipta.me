...
const NsupsDetail = () => {
  ...
  const [activeSystemNode, setActiveSystemNode] = useState("bootcamp");
  const [activeTable, setActiveTable] = useState("Bootcamp Core");
  const [activeWorkflow, setActiveWorkflow] = useState("crawler_sync");

  /* ── SEO Meta updates ── */
  useEffect(() => {
    // 1. Update Document Title
    document.title = "NSUPS - Junior Software Engineer Bootcamp Crawler & Backend | Sudipta Mandal";
    ...
    descriptionMeta.setAttribute(
      'content',
      "Architectural breakdown of Sudipta Mandal's work at NSUPS: developing relational bootcamp REST backends and automating online judge statistics crawlers."
    );
