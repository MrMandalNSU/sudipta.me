...
const SportsFixturesDetail = () => {
  ...
  const tocSections = [
    ...
    { id: "search-engine", label: "Search & Filtering" },
  ...
  const [activeTable, setActiveTable] = useState("ER Relationships");
  const [activeWorkflow, setActiveWorkflow] = useState("auth");

  /* ── SEO Meta updates ── */
  useEffect(() => {
    // 1. Update Document Title
    document.title = "Sports Fixtures - Scalable CMS Backend & WebSocket Flows | Sudipta Mandal";
      ...
      <Container maxWidth="xl" sx={{ px: { xs: 2, sm: 3, md: 5 } }}>
        ...
        <Box sx={{ display: "flex", gap: { md: 5, lg: 6 } }}>
          ...
          <Box sx={{ flex: 1, minWidth: 0, pt: 4 }}>
            ...
            {/* ════ Section 4: Event Filtering & Relevance Sandbox ════ */}
            <SearchFilterSection theme={theme} />
...
export default SportsFixturesDetail;
