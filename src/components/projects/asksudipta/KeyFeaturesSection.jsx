...
const KeyFeaturesSection = ({ theme }) => {
  ...
  return (
    <Box id="features" sx={{ scrollMarginTop: 120, mb: 4 }}>
      ...
      <Typography variant="body2" color="text.secondary" sx={{ mb: 4, maxWidth: 690 }}>
        Core capabilities that make the assistant grounded, traceable, and fast.
      ...
      <Grid container spacing={2}>
        {features.map((f, i) => {
          ...
          return (
            <Grid key={f.title} size={{ xs: 6, sm: 6, lg: 4 }}>
              <GlassCard
