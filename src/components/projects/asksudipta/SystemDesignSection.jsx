...
const SystemDesignSection = ({ theme, activeSystemNode, setActiveSystemNode, primaryColor }) => {
  ...
  const nodeDefs = [
    ...
    { key: "retrieval", type: "decision", x: 755, y: 87, label: "Retrieve?", sub: "Hybrid" },
  ...
  const lines = [
    ...
    { from: "api", to: "retrieval", path: "M 655 86 L 707 86" },
    { from: "retrieval", to: "supabase", path: "M 755 132 L 755 278 L 685 278" },
    { from: "supabase", to: "retrieval", path: "M 592 236 C 610 186, 695 166, 735 123", dashed: true },
    { from: "retrieval", to: "prompt", path: "M 803 86 L 870 86" },
