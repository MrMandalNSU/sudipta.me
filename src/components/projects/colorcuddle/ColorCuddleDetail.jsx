...
import StateStorageSection from "./StateStorageSection";
...
const ColorCuddleDetail = () => {
  ...
  const tocSections = [
    ...
    { id: "database", label: "State & Storage" },
    { id: "features", label: "Key Features" },
    { id: "snapshots", label: "Snapshots" },
  ];

  const [activeSection, setActiveSection] = useState("overview");
  const [activeSystemNode, setActiveSystemNode] = useState("orchestrator");
  const [activeTable, setActiveTable] = useState("localStorage");
  const [activeWorkflow, setActiveWorkflow] = useState("initialization");
  ...
  useEffect(() => {
    ...
    document.title = "Color Cuddle - Interactive Web Game & UI State System | Sudipta Mandal";
    ...
    descriptionMeta.setAttribute('content', 'Detailed breakdown of Color Cuddle: An interactive, low-latency color permutation puzzle web game built on Next.js 15, React 19, and Tailwind CSS v4, featuring glassmorphism overlays and streaks caching.');
    ...
    canonicalLink.setAttribute('href', 'https://sudipta.xyz/projects/colorcuddle');
...
export default ColorCuddleDetail;
