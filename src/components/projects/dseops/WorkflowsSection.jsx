...
const highlightJson = (obj) => {
  ...
  return lines.map((line, index) => {
    ...
    // 2. Match string elements inside arrays (e.g. "item", or "item")
  ...
  return (
    <Box id="workflows" sx={{ scrollMarginTop: 120, mb: 4 }}>
      ...
      <Typography variant="body2" color="text.secondary" sx={{ mb: 4, maxWidth: 700 }}>
        Detailed workflow maps documenting daily scrapes, cloud generation sequences, and search queries.
      </Typography>
        ...
        <Grid size={{ xs: 12, lg: 3 }} sx={{ order: { xs: 1, lg: 2 } }}>
          ...
          >
            ...
            >
              ...
              >
                {activeWorkflow === "scrape" && "Scrape Webhook Payload"}
                {activeWorkflow === "download" && "CSV Stream Payload"}
                {activeWorkflow === "query" && "Client API Query"}
              </Typography>
