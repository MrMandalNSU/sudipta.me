...
const TextAnalyzerDetail = () => {
  ...
  const [activeSystemNode, setActiveSystemNode] = useState("client");
  const [activeTable, setActiveTable] = useState("Text");
  const [activeWorkflow, setActiveWorkflow] = useState("session");
  ...
  useEffect(() => {
    ...
    document.title = "Text Analyzer - Lexical Metric Caching & Utilities | Sudipta Mandal";
    ...
    descriptionMeta.setAttribute('content', 'Detailed breakdown of Text Analyzer: A full-stack lexical metrics engine built with React, Vite, Express, TypeScript, and MongoDB Atlas. Features anonymous session-based workspace sandboxes, regex word parsing, clean text formatting filters, and live JSON tree editors.');
    ...
    canonicalLink.setAttribute('href', 'https://sudipta.xyz/projects/textanalyzer');
...
export default TextAnalyzerDetail;
