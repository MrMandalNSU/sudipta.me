  ...
  return (
    <Box id="workflows" sx={{ scrollMarginTop: 120, mb: 4 }}>
      ...
      <Typography variant="body2" color="text.secondary" sx={{ mb: 4, maxWidth: 700 }}>
        Detailed component workflows mapping local session initialization, text insertion, lexical metrics hydration, and cache invalidation.
      </Typography>
                  ...
                  <Box sx={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
                    <Box
                      sx={{
                        ...
                        height: 26,
                        borderRadius: "50%",
                        backgroundColor: theme.palette.mode === "light" ? "rgba(99,102,241,0.08)" : "rgba(129,140,248,0.15)",
                        color: "primary.main",
                        display: "flex",
                        alignItems: "center",
                        ...
                        fontSize: "0.75rem",
                        fontWeight: 800,
                        border: `1px solid ${theme.palette.mode === "light" ? "rgba(99,102,241,0.15)" : "rgba(129,140,248,0.25)"}`,
                      }}
                    >
                      {index + 1}
                    </Box>
        ...
        <Grid size={{ xs: 12, lg: 3 }} sx={{ order: { xs: 1, lg: 2 } }}>
              ...
              return (
                ...
                >
                  ...
                  <Box component="span" sx={{ display: { xs: "none", lg: "inline" } }}>
                    {flow.title.split(" Flow")[0].split(" Engine")[0].split(" Workflow")[0]}
                  </Box>
                </Button>
              );
            })}
          ...
          >
            ...
            >
              ...
              >
                {activeWorkflow === "session" && "Session Payload"}
                {activeWorkflow === "ingestion" && "CRUD Payload"}
                {activeWorkflow === "analysis" && "Metrics Payload"}
                {activeWorkflow === "invalidation" && "Invalidation Payload"}
              </Typography>
